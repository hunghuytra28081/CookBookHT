...
class NutrientDetailFragment(
    ...
    private val sheetChart by lazy { BottomSheetBehavior.from(bottomSheetChart) }
    ...
    private fun initListener() {
        ...
        sheetChart.addBottomSheetCallback(object : BottomSheetBehavior.BottomSheetCallback() {
    ...
    private fun generateCenterSpannableText(): SpannableString? {
        ...
        s.setSpan(ForegroundColorSpan(resources.getColor(R.color.color_purple_black)), 3, 7, 0)
        s.setSpan(StyleSpan(Typeface.BOLD), 0, 7, 0)
