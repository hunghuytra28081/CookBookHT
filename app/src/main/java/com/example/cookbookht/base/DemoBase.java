...
package com.example.cookbookht.base;
...
public abstract class DemoBase extends AppCompatActivity implements ActivityCompat.OnRequestPermissionsResultCallback {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        tfRegular = Typeface.createFromAsset(getAssets(), "open_sans_regular.ttf");
        tfLight = Typeface.createFromAsset(getAssets(), "open_sans_ight.ttf");
    }
